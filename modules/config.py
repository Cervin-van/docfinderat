...
CITIES = [
    ...
    'Klosterneuburg', 'Baden', 'Wolfsberg', 'Leoben', 'Krems an der Donau',
    'Traun', 'Amstetten', 'Lustenau', 'Kapfenberg', 'Mödling',
    'Hallein', 'Kufstein', 'Traiskirchen', 'Schwechat', 'Braunau am Inn',
    'Stockerau', 'Saalfelden am Steinernen Meer', 'Ansfelden', 'Tulln an der Donau', 'Hohenems',
    'Spittal an der Drau', 'Telfs', 'Ternitz', 'Perchtoldsdorf', 'Feldkirchen in Kärnten',
    'Bludenz', 'Bad Ischl', 'Eisenstadt', 'Schwaz', 'Hall in Tirol',
    'Gmunden', 'Wörgl', 'Wals-Siezenheim', 'Hard', 'Korneuburg'
]
